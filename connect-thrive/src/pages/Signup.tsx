...
import { Eye, EyeOff, Mail, Lock, User, MapPin, Sparkles } from "lucide-react";
    ...
    try {
      ...
      toast({
        ...
        description:
          ...
          "Welcome to Connecto. Please login to continue.",
      });

      // Signup ke baad login par bhejna better hota hai
      navigate("/login");
    } catch (error) {
      // 4. Error Handling (Domain validation, duplicate email, etc.)
      toast({
        title: "Signup Failed",
        description:
